...
namespace WebApi.Controllers
{
    ...
    public class GangersController : ApiController
    {
        ...
        public GangerWeapon AddGangerWeapon([FromUri] string gangerId, [FromUri] string gangWeaponId)
        {
        ...
        public void RemoveGangerWeapon([FromUri] string gangerId, [FromUri] string gangerWeaponId)
        {
