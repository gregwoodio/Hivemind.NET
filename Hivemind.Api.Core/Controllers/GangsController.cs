...
namespace WebApi.Controllers
{
    ...
    public class GangsController : Controller
    {
        ...
        [HttpGet]
        [Route("{gangId}")]
        public Gang GetGang([FromRoute] string gangId)
        {
        ...
        [HttpPost]
        [Route("")]
        public Gang AddGang([FromForm] Gang gang)
        {
        ...
        public IEnumerable<Weapon> GetGangStash([FromRoute] string gangId)
        {
        ...
        [HttpPost]
        [Route("{gangId}/weapons")]
        public GangWeapon AddGangWeapon([FromRoute] string gangId, GangWeapon gangWeapon)
        {
        ...
        public IEnumerable<Weapon> GetGangerWeapons([FromRoute] string gangId)
        {
