...
& 'D:\BuildTools\OpenCover.4.6.519\tools\OpenCover.Console.exe' -register:user -target:"D:\BuildTools\NUnit.org\nunit-console\nunit3-console.exe" -output:$CoverageDir\OpenCoverOutput.xml -targetargs:"D:\Jenkins\workspace\Hivemind\Hivemind.Tests\Hivemind.Tests.csproj" -mergebyhash -skipautoprops -filter:"+[*]* -[Moq*]*"
